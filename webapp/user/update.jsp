      ...
      <div class="panel panel-default content-main">
          <form name="question" method="post" action="/user/update">
              <div class="form-group">
                  ...
                  <input class="form-control" id="userId" name="userId" placeholder="User ID" value="${user.userId}" readonly = true>
              </div>
              <div class="form-group">
              ...
              <button type="submit" class="btn btn-success clearfix pull-right">수정완</button>
              <div class="clearfix" />
          </form>
        </div>
    </div>
